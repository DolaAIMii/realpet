...
echo "  ./build_app.sh"
echo ""
echo "Tip: HuggingFace (BiRefNet) may be slow / blocked in some regions."
echo "For first run, optionally set a mirror BEFORE running the app:"
echo "  export HF_ENDPOINT=https://hf-mirror.com"
echo "(app picks it up automatically; default is huggingface.co)"
